    ...
    <div>
      ...
      <div className="projects-page-div">
        ...
        <Project
          ...
          btnRepo="https://github.com/alina-p17/alina-p17.github.io/tree/main/public/live-projects/rock-paper-scissors"
        />
        <Project
          counter={counter++}
          projectImgSrc="/images/monsters_game.png"
          projectTitle="Monsters Game"
          projectText=" I've implemented a game in which the user uses the arrow keys to help Mario move in order to reach the door and escape the monsters. If Mario encounters a monster the number of his lives decreases. The users has 3 chances to win the game."
          focusOn=" ES6 Modules |  ES6 Classes | OOP "
          btnLive="/live-projects/monster-game"
          btnRepo="https://github.com/alina-p17/alina-p17.github.io/tree/main/public/live-projects/monster-game"
        />
        <Project
          counter={counter++}
          ...
          btnRepo="https://github.com/alina-p17/alina-p17.github.io/tree/main/public/live-projects/digital-timer"
        />
        <Project
          counter={counter++}
          ...
          btnRepo="https://github.com/alina-p17/alina-p17.github.io/tree/main/public/live-projects/bmi-calculator"
        />
        <Project
          counter={counter++}
          projectImgSrc="/images/API-calls.png"
          projectTitle="Random Pictures Generator"
          projectText=" Are you a cat person or a dog person? Eitherway you can have some fun with this small project which shows you random pictures of your favourite pet."
          focusOn=" HTML | CSS | JavaScript+ES6 | API calls "
          btnLive="/live-projects/api-calls"
          btnRepo="https://github.com/alina-p17/alina-p17.github.io/tree/main/public/live-projects/api-calls"
        />
        <Project
          counter={counter++}
          ...
          btnRepo="https://github.com/alina-p17/alina-p17.github.io/tree/main/public/live-projects/spaceships"
        />
        <Project
          counter={counter++}
          ...
          btnRepo="https://github.com/alina-p17/alina-p17.github.io/tree/main/public/live-projects/comment-box"
        />
        <Project
          counter={counter++}
          ...
          btnRepo="https://github.com/alina-p17/alina-p17.github.io/tree/main/public/live-projects/travel-blog"
        />
      </div>
    </div>
  );
